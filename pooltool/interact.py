    ...
    Args:
        shot_or_shots:
            ...
            Note:
                ...
                pressing *n* (next) and *p* (previous). When using :func:`show`,
                ...
                Note that parallel visualization is only available in :func:`show`
                and not when playing the game through the CLI ``run-pooltool``.
        title:
