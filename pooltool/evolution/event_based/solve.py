...
def ball_linear_cushion_collision_time(
    ...
    if direction == 0:
        ...
        root1, root2 = math.quadratic.solve(A, B, C)
        roots = [root1, root2]
    elif direction == 1:
        C = l0 + lx * cx + ly * cy - R * np.sqrt(lx**2 + ly**2)
        root1, root2 = math.quadratic.solve(A, B, C)
        ...
        root1, root2 = math.quadratic.solve(A, B, C1)
        root3, root4 = math.quadratic.solve(A, B, C2)
...
def ball_circular_cushion_collision_coeffs_slow(rvw, s, a, b, r, mu, m, g, R):
    """Get quartic coeffs required to determine the ball-circular-cushion collision time
...
def ball_circular_cushion_collision_time(rvw, s, a, b, r, mu, m, g, R):
    ...
    mu : float
        The rolling or sliding coefficient of friction. Should match the value of s
    """
    A, B, C, D, E = ball_circular_cushion_collision_coeffs_slow(
...
def ball_pocket_collision_coeffs_slow(rvw, s, a, b, r, mu, m, g, R):
...
def ball_pocket_collision_time(rvw, s, a, b, r, mu, m, g, R):
