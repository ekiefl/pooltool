...
def get_next_ball_ball_collision(
    ...
    if len(collision_coeffs):
        roots = get_smallest_physical_roots(
...
def get_next_ball_pocket_collision_old(
    shot: System,
    collision_cache: CollisionCache,
    solver: QuarticSolver = QuarticSolver.HYBRID,
) -> Event:
    ...
    FIXME-3D Hopefully profile this and pray it's slower, or at least not much faster,
    than `get_next_ball_pocket_collisions`
    """
