...
from pooltool.ai.datatypes import (
    LightZeroImageEnv,
    ObservationDict,
    Spaces,
    State,
...
def single_player_env(random_pos: bool = False) -> LightZeroImageEnv:
...
def reset_single_player_env(env: LightZeroImageEnv) -> LightZeroImageEnv:
...
def get_env(state: State) -> LightZeroImageEnv:
    ...
    return LightZeroImageEnv(
        ...
        game=state.game,
        spaces=Spaces(
            observation=LightZeroImageEnv.get_obs_space(renderer),
            action=spaces.Box(
