...
from pooltool.physics.utils import tangent_surface_velocity_vw
...
def resolve_sphere_half_space_collision_z_normal(v_i, w_i, R, mu_k, e):
    unit_z = np.array([0.0, 0.0, 1.0])
    ...
    v_c_i = tangent_surface_velocity_vw(v_i, w_i, -unit_z, R)
