    ...
    while True:
        try:
            ...
            if buffer_size > 0 and len(shots) % buffer_size == 0:
                stats, break_count, session_best, best_break = process_shots(shots, stats, break_count, session_best, best_break, interface)
                print_stats(stats, run)
                shots = []
...
if __name__ == '__main__':
    ...
    ap.add_argument('-T', '--threads', default=4, type=int, help="How many threads should be used?")
