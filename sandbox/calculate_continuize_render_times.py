...
if __name__ == '__main__':
    ...
    ap = argparse.ArgumentParser('Compare timings of shot calculation, continuization, and animation rendering')
    ap.add_argument('--path', type=str, required=True, help="Filepath to a shot (you could generate this with sandbox/break.py, for example)")
