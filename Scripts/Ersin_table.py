...
def custom_table_specs() -> pt.objects.BilliardTableSpecs:
    return pt.objects.BilliardTableSpecs(
        l=2.84,
        w=1.42,
        cushion_width=0.05,
...
def main():
    ...
    balls = pt.get_rack(pt.GameType.THREECUSHION, table=table, ball_params=ball_params)
