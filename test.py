...
TITLE_FONT = 'labtop-secundo/LABTSECW.ttf'
...
class Menu(object):
    def __init__(self, xml):
        ...
        self.title_font = loader.loadFont(TITLE_FONT)
        ...
        self.area_backdrop.setImage('menu_background.jpeg')
        img = OnscreenImage(
    ...
    def add_button(self, item):
        ...
        button = DirectButton(
            ...
            text_font = self.font,
            scale=TEXT_SCALE,
            geom=loadImageAsPlane(panda_path('button.png')),
            relief=None,
        )
        ...
        info_button = DirectButton(
            ...
            text_align = TextNode.ALeft,
            scale=INFO_SCALE,
            image=panda_path('info_button.png'),
            relief=None,
        )
...
class Menus(object):
    def __init__(self):
        self.menus = {}
        self.xml = XMLMenu(path='menus.xml')
